...
if(!function_exists('custom_post_type_gpieugd')) {
    function custom_post_type_gpieugd() {
        ...
        $labels = array(
            ...
            'singular_name'       => _x( 'GPIEUGD', 'Post Type Singular Name', 'sputnik-wp-theme' ),
            'menu_name'           => __( 'GPIEUGD', 'sputnik-wp-theme' ),
            'parent_item_colon'   => __( 'Nadrzędna GPIEUGD', 'sputnik-wp-theme' ),
            'all_items'           => __( 'Wszystkie GPIEUGD', 'sputnik-wp-theme' ),
            'view_item'           => __( 'Zobacz GPIEUGD', 'sputnik-wp-theme' ),
            'add_new_item'        => __( 'Dodaj nową GPIEUGD', 'sputnik-wp-theme' ),
            'add_new'             => __( 'Dodaj nową', 'sputnik-wp-theme' ),
            'edit_item'           => __( 'Edytuj GPIEUGD', 'sputnik-wp-theme' ),
            'update_item'         => __( 'Zaaktualizuj GPIEUGD', 'sputnik-wp-theme' ),
            'search_items'        => __( 'Wyszukaj GPIEUGD', 'sputnik-wp-theme' ),
        ...
        $args = array(
            'label'               => __( 'GPIEUGD', 'sputnik-wp-theme' ),
            'description'         => '',
            'labels'              => $labels,
    ...
    add_action( 'init', 'custom_post_type_gpieugd', 0 );
}
...
if(!function_exists('tax_custom_post_type_gpieugd_categories')) {
    ...
    add_action( 'init', 'tax_custom_post_type_gpieugd_categories', 0 );
}