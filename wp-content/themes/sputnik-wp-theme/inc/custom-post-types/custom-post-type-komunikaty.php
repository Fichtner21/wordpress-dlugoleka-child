...
if(!function_exists('custom_post_type_komunikaty')) {
    function custom_post_type_komunikaty() {
        $labels = array(
            ...
            'singular_name'       => _x( 'Komunikat', 'Post Type Singular Name', 'sputnik-wp-theme' ),
            'menu_name'           => __( 'Komunikaty', 'sputnik-wp-theme' ),
            'parent_item_colon'   => __( 'Nadrzędny komunikat', 'sputnik-wp-theme' ),
            'all_items'           => __( 'Wszystkie komunikaty', 'sputnik-wp-theme' ),
            'view_item'           => __( 'Zobacz komunikat', 'sputnik-wp-theme' ),
            'add_new_item'        => __( 'Dodaj nowy komunikat', 'sputnik-wp-theme' ),
            'add_new'             => __( 'Dodaj nowy', 'sputnik-wp-theme' ),
            'edit_item'           => __( 'Edytuj komunikat', 'sputnik-wp-theme' ),
            'update_item'         => __( 'Zaaktualizuj komunikat', 'sputnik-wp-theme' ),
            'search_items'        => __( 'Wyszukaj komunikat', 'sputnik-wp-theme' ),
        ...
        $args = array(
            'label'               => __( 'komunikaty', 'sputnik-wp-theme' ),
            'description'         => '',
            'labels'              => $labels,
    ...
    add_action( 'init', 'custom_post_type_komunikaty', 0 );
}

if(!function_exists('tax_custom_post_type_komunikaty_categories')) {
    ...
    add_action( 'init', 'tax_custom_post_type_komunikaty_categories', 0 );
}